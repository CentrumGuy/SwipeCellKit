...
public struct SwipeOptions {
    ...
    /// The amount of space, in points, between the left border and the button image or title.
    public var buttonPaddingLeft: CGFloat?
    
    /// The amount of space, in points, between the right border and the button image or title.
    public var buttonPaddingRight: CGFloat?
